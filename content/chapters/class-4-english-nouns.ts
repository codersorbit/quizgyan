...
const chapter: Chapter = {
  ...
  examples: [
    ...
    { problem: "Is ‘Ganga’ a common or proper noun?", solution: "Proper noun." },
    { problem: "Pick the proper noun: dog, Tipu, river.", solution: "Tipu." },
    { problem: "Why does ‘Rahul’ start with a capital letter?", solution: "Because it is a proper noun — a particular name." },
  ],
  commonMistakes: [
  ...
  mcqs: [
    ...
    },
    {
      ...
      options: ["girl", "India", "city", "book"],
      answer: 1,
      explanation: "‘India’ is a particular name, so it is a proper noun.",
      difficulty: "easy",
    },
    {
      id: "w4e-noun-7",
      q: "Which word is a common noun?",
      options: ["Rahul", "Kolkata", "teacher", "Ganga"],
      answer: 2,
      explanation: "‘teacher’ is a general name — a common noun.",
      difficulty: "easy",
    },
    {
      id: "w4e-noun-8",
      q: "A proper noun always begins with a ___.",
      options: ["small letter", "capital letter", "number", "full stop"],
      answer: 1,
    ...
    {
      id: "w4e-noun-9",
      q: "In ‘Mumbai is a big city’, which is the proper noun?",
      options: ["big", "city", "Mumbai", "is"],
      answer: 2,
      explanation: "‘Mumbai’ is the particular name — a proper noun.",
      difficulty: "medium",
    },
    {
      id: "w4e-noun-10",
      q: "Which word is NOT a noun?",
      options: ["apple", "run", "school", "Riya"],
      answer: 1,
      explanation: "‘run’ is an action word (verb), not a naming word.",
      difficulty: "medium",
    },
  ],
  shortQuestions: [
