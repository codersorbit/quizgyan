...
const chapter: Chapter = {
  ...
  examples: [
    ...
    { problem: "‘I ___ now.’ (eat)", solution: "am eating." },
    { problem: "‘He ___ fast.’ (run)", solution: "is running." },
    { problem: "Add -ing: ‘sing’ → ?", solution: "singing." },
  ],
  commonMistakes: [
  ...
  mcqs: [
    ...
    {
      id: "w4e-tense-6",
      q: "‘She ___ a song.’ (sing)",
      options: ["am singing", "is singing", "are singing", "sing"],
      answer: 1,
      explanation: "With ‘She’ we use ‘is’ → is singing.",
      difficulty: "easy",
    },
    {
      id: "w4e-tense-7",
      q: "Which helping verb goes with ‘I’?",
    ...
    {
      id: "w4e-tense-8",
      q: "The present continuous shows an action ___.",
      options: ["yesterday", "happening now", "tomorrow", "never"],
      answer: 1,
      explanation: "The present continuous shows an action happening now.",
      difficulty: "easy",
    },
    {
      id: "w4e-tense-9",
      q: "‘They ___ football.’ (play)",
      options: ["is playing", "am playing", "are playing", "plays"],
      answer: 2,
      explanation: "With ‘They’ we use ‘are’ → are playing.",
      difficulty: "medium",
    },
    {
      id: "w4e-tense-10",
      q: "Add -ing correctly: ‘run’ → ?",
